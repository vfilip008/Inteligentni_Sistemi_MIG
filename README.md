...
**Датасет:** Codeforces Problem Dataset (~10,900 задачи) — вклучен во репото
...
> ⚠️ За време на инсталација на Windows, штиклирај **"Add Python to PATH"**
...
> ⚠️ `set` / `export` важи само за тековната терминал сесија. Ако го затворите терминалот, треба повторно да го поставите клучот пред следното стартување.
